...
const Bookmd = () => {
    ...
    return (
        <div className='h-[80vh]'>
            <div className='w-[100%] lg:h-[100vh] xl:h-[160vh] bg-[#E6ECE8] pt-20 pb-10 md:pt-20 xl:pt-40 md:mt-0 md:pb-16 xl:pb-20 flex flex-col justify-center xl:justify-normal items-center'>
